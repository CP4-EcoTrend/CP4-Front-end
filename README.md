...
Vinicisu Kozonoe — RM RM567264
Maria Luiza Kochnoff da Matta RM — RM568459
...
O projeto também busca aplicar boas práticas de organização visual, navegação e experiência do usuário (UI/UX).
...
Ajustes de espaçamento, fontes e componentes para telas menores
